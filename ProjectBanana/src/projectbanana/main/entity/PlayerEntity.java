	...
	public void tick() {
		try {
			...
			// Calculate movement
				...
				// If turning
				if(Engine.gameInputHandler.isLeft()) this.turn(Rotation.COUNTER_CLOCKWISE, rotSpeed, rotThrust);
				if(Engine.gameInputHandler.isRight()) this.turn(Rotation.CLOCKWISE, rotSpeed, rotThrust);
